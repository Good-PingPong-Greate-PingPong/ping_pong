...
INSERT INTO "new_Match" ("createdAt", "id", "isDeleted", "participant1Id", "participant2Id", "round", "scheduledAt", "status", "tournamentId", "updatedAt") SELECT "createdAt", "id", "isDeleted", "participant1Id", "participant2Id", "round", "scheduledAt", "status", "tournamentId", "updatedAt" FROM "Match";
DROP TABLE "Match";
